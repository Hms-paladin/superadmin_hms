...
export default class Advertise_manage extends Component {
    ...
    .then(function (response) {
      ...
      self.didmount_recall("success","added")
...
didmount_recall=(type,msgdyn)=>{
  ...
  .then(axios.spread((ad_rate,vendor,placement) => {
    ...
    console.log(rate_ven_place_arrval,"rate_ven_place_arrval")
...
Update_rate=()=>{
  ...
  if(this.state.placement){
    ...
    console.log(vendor_update_val,"rate")
    console.log(place_update_val,"rate")
...
delete_data_rate=(id)=>{
  ...
  .then(function (response) {
    self.didmount_recall("success","Deleted")
    self.setState({
    })
  })
  .catch(function (error) {
...
<div className="mt-3">
<Button className="advertise_button_create" onClick={this.update_img}>Update</Button>
</div>
</div>
...
<div className="mt-3">
<Button className="advertise_button_create" onClick={this.update_disduration}>Update</Button>
</div>
...
<Button className="advertise_button_create add_ad_topalign" onClick={this.iconclick}>Add</Button>:<Button className="advertise_button_create add_ad_topalign" onClick={this.Update_rate}>Update</Button>}
</div>
</div>
<div className="mt-4">
