...
import './ViewManageCatagory.css'
// import uploadimage from '../../images/upload-button.png'
// import Profile from '../../images/1.jpg' 

export default class DeleteManage extends Component {
    render() {
        return (
            <div className="record_delete_container"> 
                <Grid container>
                    <Grid item xs={12} md={12} className="media_title_container">
                      <div className="mediadelete_container"><p className="delete_para">Are You Sure Want to Delete ?</p></div>
