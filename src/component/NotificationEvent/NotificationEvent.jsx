...
export default class Notification_Event extends React.Component{
        ...
        return(
            <div>
               ...
               <div className="Notification_manage_header">
                   <div className="Notification_manage_title"><h3>NOTIFICATION EVENT</h3></div>
                  
               </div>
               <Paper style={{marginTop:'5px'}}>
                   <div className="row1_flex">
                       <div className="catgry_box">
                   <Labelbox  type="text" labelname="Event"/>
                   </div>
