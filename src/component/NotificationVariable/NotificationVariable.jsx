...
export default class Notification_Variable extends React.Component{
        ...
        return(
            <div>
               ...
               <div className="Notification_manage_header">
                   <div className="Notification_manage_title"><h3>NOTIFICATION VARIABLE</h3></div>
                  
               </div>
               <Paper style={{marginTop:'5px'}}>
                   <div className="variable_flex">
                       <div className="catgry_box evnt_bx">
                   <Labelbox className="event_labl" type="select" labelname="Event"/>
                   </div>
                   <div className="catgry_box">
                   <Labelbox  type="text" labelname="Variable Name"/>
                   </div><div className="catgry_box">
                   <Labelbox  type="text" labelname="API Name"/>
                   </div>
