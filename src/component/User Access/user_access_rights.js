...
recall_permission=(showNotification)=>{
  ...
  axios({
    ...
    console.log(response.data,"response_get")
    ...
    return (
      ...
      <div className="VendorDetailsDiv grp_dropdown_tble">
         <div className="group_accessrights_header">
          ...
          <h4>User</h4>
          <Dropdownantd className="accessrights-option" breakclass="drop_down_br" option={this.state.user_arr} changeData={(data)=>this.changeDynamic(data,"Group")} 
