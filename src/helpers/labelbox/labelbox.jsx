...
componentWillReceiveProps(props){
  ...
  handleSearch = value => {
	...
	renderinput=(data)=>{
        ...
        checkedIcon={<RadioButtonCheckedIcon fontSize="small" />} onClick={()=>this.changeGender('M')} checked={this.state.gender=='M'} fontSize="small"/>} label="Male" />
				<FormControlLabel value="female" control={<Radio className="radiobtncolor" icon={<RadioButtonUncheckedIcon fontSize="small" />}
        checkedIcon={<RadioButtonCheckedIcon fontSize="small" />} onClick={()=>this.changeGender('F')} checked={this.state.gender=='F'} fontSize="small"/>} label="Female" />
				</div>
